...
Route::screen('system/{system?}', SystemDataEditScreen::class)
    ->name('platform.system.edit');

Route::screen('systems', SystemDataListScreen::class)
    ->name('platform.system.list');
